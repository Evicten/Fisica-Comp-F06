...
void printVector(vector<pair<double, double>> vec)
{
...
int main()
{
  ...
  auto Vsmooth181 = D.GetMovingAverage(7);
  ...
  Gcorr_detailed->SaveAs("../img/Gcorr_detailed.pdf");
